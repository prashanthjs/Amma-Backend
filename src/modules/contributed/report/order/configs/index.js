...
const report_order_plugin_1 = require("../services/report.order.plugin");
const report_order_controller_1 = require("../services/report.order.controller");
exports.config = {
    app: {
        db: {
            schema: {
                order: {
                    plugins: {
                        reportOrderPlugin: report_order_plugin_1.ReportOrderPlugin
                    }
                }
            },
        },
    ...
    services: {
        'reportOrderController': report_order_controller_1.ReportOrderController,
    },
    routes: {
        reportOrderSummary: {
            method: 'GET',
