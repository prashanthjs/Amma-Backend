...
const shipping_method_schema_1 = require("./shipping.method.schema");
const shipping_method_route_validation_1 = require("./shipping.method.route.validation");
exports.config = {
    app: {
        db: {
            schema: {
                'shipping-method': shipping_method_schema_1.ShippingMethodSchema
            }
        },
        privilege: {
    ...
    routes: {
        ...
        shippingMethodCreate: {
            ...
            config: {
                ...
                validate: {
                    payload: shipping_method_route_validation_1.Payload
                },
                auth: {
                    scope: {
